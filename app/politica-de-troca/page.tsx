  ...
  return (
    <BeArtShell authReady footer navbar contentClassName="relative z-10 px-6 pb-20 pt-28 sm:px-10 sm:pt-32 lg:px-16">
      <section className="mx-auto max-w-4xl rounded-[2.2rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] px-8 py-10 shadow-[0_28px_80px_rgba(0,0,0,0.32)] backdrop-blur-2xl sm:px-12">
        <p className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.45em] text-[#8B5CF6]"><RefreshCcw className="h-4 w-4" aria-hidden="true" />Politica de troca</p>
        ...
        <ul className="mt-8 space-y-3">
          {exchangeItems.map((item) => (
            <li key={item} className="flex items-start gap-3 rounded-[1.4rem] border border-white/10 bg-white/[0.04] px-5 py-4 text-base leading-8 text-white/62">
              <BadgeCheck className="mt-1 h-4 w-4 shrink-0 text-[#BFC6FF]" aria-hidden="true" />
              {item}
            </li>
          ))}
        </ul>
